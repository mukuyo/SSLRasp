...
bool message_info__msg__detection_ball__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("message_info.msg._detection_ball.DetectionBall", full_classname_dest, 46) == 0);
  }
  message_info__msg__DetectionBall * ros_message = _ros_message;
  {  // pose
...
PyObject * message_info__msg__detection_ball__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("message_info.msg._detection_ball");
