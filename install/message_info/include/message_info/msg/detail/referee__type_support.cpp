...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Referee_message_member_array[9] = {
  {
    "stage",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(message_info::msg::Referee, play),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(message_info::msg::Referee, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
