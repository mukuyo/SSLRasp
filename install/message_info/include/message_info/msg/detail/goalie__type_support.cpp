...
{
  new (message_memory) message_info::msg::Goalie(_init);
}

void Goalie_fini_function(void * message_memory)
{
  auto typed_message = static_cast<message_info::msg::Goalie *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Goalie_message_member_array[1] = {
  {
    ...
    offsetof(message_info::msg::Goalie, pose),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Goalie_message_members = {
  ...
  "Goalie",  // message name
  1,  // number of fields
  sizeof(message_info::msg::Goalie),
...
{
  return &::message_info::msg::rosidl_typesupport_introspection_cpp::Goalie_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, message_info, msg, Goalie)() {
  return &::message_info::msg::rosidl_typesupport_introspection_cpp::Goalie_message_type_support_handle;
}
