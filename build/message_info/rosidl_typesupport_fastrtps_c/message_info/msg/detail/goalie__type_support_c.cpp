...
#include "message_info/msg/detail/goalie__rosidl_typesupport_fastrtps_c.h"
...
using _Goalie__ros_msg_type = message_info__msg__Goalie;
...
size_t get_serialized_size_message_info__msg__Goalie(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Goalie__ros_msg_type * ros_message = static_cast<const _Goalie__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Goalie__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_message_info__msg__Goalie(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_message_info
size_t max_serialized_size_message_info__msg__Goalie(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_message_info__msg__Goalie(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, message_info, msg, Goalie)() {
