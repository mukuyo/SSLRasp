...
#include "message_info/msg/detail/detection_ball__rosidl_typesupport_fastrtps_c.h"
...
using _DetectionBall__ros_msg_type = message_info__msg__DetectionBall;
...
static uint32_t _DetectionBall__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_message_info__msg__DetectionBall(
...
{
  return max_serialized_size_message_info__msg__DetectionBall(
    full_bounded, 0);
}
