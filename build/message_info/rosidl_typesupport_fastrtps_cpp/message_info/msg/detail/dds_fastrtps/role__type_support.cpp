...
#include "message_info/msg/detail/role__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const message_info::msg::Role & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: defense
  {
    cdr << ros_message.defense;
  }
  // Member: offense
  {
    cdr << ros_message.offense;
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  message_info::msg::Role & ros_message)
{
  // Member: attacker
  cdr >> ros_message.attacker;
  ...
  size_t current_alignment)
{
  ...
  // Member: defense
  {
    ...
    size_t item_size = sizeof(ros_message.defense[0]);
  ...
  {
    size_t array_size = 10;
    size_t item_size = sizeof(ros_message.offense[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: offense_count
...
{
  auto typed_message =
    static_cast<const message_info::msg::Role *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<message_info::msg::Role *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Role__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const message_info::msg::Role *>(
...
{
  return max_serialized_size_Role(full_bounded, 0);
}

static message_type_support_callbacks_t _Role__callbacks = {
  "message_info::msg",
  "Role",
...
static rosidl_message_type_support_t _Role__handle = {
...
{
  return &message_info::msg::typesupport_fastrtps_cpp::_Role__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, message_info, msg, Role)() {
  return &message_info::msg::typesupport_fastrtps_cpp::_Role__handle;
}
