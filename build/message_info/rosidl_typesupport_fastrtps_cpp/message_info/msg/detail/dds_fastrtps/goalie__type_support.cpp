...
#include "message_info/msg/detail/goalie__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const message_info::msg::Goalie & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  message_info::msg::Goalie & ros_message)
{
  // Member: pose
...
{
  auto typed_message =
    static_cast<const message_info::msg::Goalie *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<message_info::msg::Goalie *>(
    untyped_ros_message);
...
{
  return &message_info::msg::typesupport_fastrtps_cpp::_Goalie__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, message_info, msg, Goalie)() {
  return &message_info::msg::typesupport_fastrtps_cpp::_Goalie__handle;
}
