...
{
  new (message_memory) message_info::msg::DetectionRobot(_init);
}

void DetectionRobot_fini_function(void * message_memory)
{
  auto typed_message = static_cast<message_info::msg::DetectionRobot *>(message_memory);
  typed_message->~DetectionRobot();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember DetectionRobot_message_member_array[4] = {
  {
    "pose",  // name
    ...
    offsetof(message_info::msg::DetectionRobot, pose),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(message_info::msg::DetectionRobot, robot_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(message_info::msg::DetectionRobot, is_yellow),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(message_info::msg::DetectionRobot, empty),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DetectionRobot_message_members = {
  ...
  4,  // number of fields
  sizeof(message_info::msg::DetectionRobot),
...
{
  return &::message_info::msg::rosidl_typesupport_introspection_cpp::DetectionRobot_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, message_info, msg, DetectionRobot)() {
  return &::message_info::msg::rosidl_typesupport_introspection_cpp::DetectionRobot_message_type_support_handle;
}
