...
static const _FieldCircularArc_type_support_symbol_names_t _FieldCircularArc_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, message_info, msg, FieldCircularArc)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, message_info, msg, FieldCircularArc)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, message_info, msg, FieldCircularArc)() {
  return &::message_info::msg::rosidl_typesupport_c::FieldCircularArc_message_type_support_handle;
}
