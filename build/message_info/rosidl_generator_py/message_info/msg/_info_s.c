...
bool message_info__msg__info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("message_info.msg._info.Info", full_classname_dest, 27) == 0);
  }
  message_info__msg__Info * ros_message = _ros_message;
  {  // name
  ...
  {  // frame
    ...
    if (!message_info__msg__detection_frame__convert_from_py(field, &ros_message->frame)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // geometry
    ...
    if (!message_info__msg__vision_geometry__convert_from_py(field, &ros_message->geometry)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // role
    ...
    if (!message_info__msg__role__convert_from_py(field, &ros_message->role)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * message_info__msg__info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("message_info.msg._info");
  ...
  {  // frame
    PyObject * field = NULL;
    field = message_info__msg__detection_frame__convert_to_py(&ros_message->frame);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // geometry
    PyObject * field = NULL;
    field = message_info__msg__vision_geometry__convert_to_py(&ros_message->geometry);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // role
    PyObject * field = NULL;
    field = message_info__msg__role__convert_to_py(&ros_message->role);
    if (!field) {
      return NULL;
    }
    {
