  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  message_info__msg__DetectionBall__init(message_memory);
}

void DetectionBall__rosidl_typesupport_introspection_c__DetectionBall_fini_function(void * message_memory)
{
  message_info__msg__DetectionBall__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember DetectionBall__rosidl_typesupport_introspection_c__DetectionBall_message_member_array[2] = {
  {
    "pose",  // name
    ...
    offsetof(message_info__msg__DetectionBall, pose),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(message_info__msg__DetectionBall, empty),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers DetectionBall__rosidl_typesupport_introspection_c__DetectionBall_message_members = {
  ...
  2,  // number of fields
  sizeof(message_info__msg__DetectionBall),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, message_info, msg, DetectionBall)() {
  DetectionBall__rosidl_typesupport_introspection_c__DetectionBall_message_member_array[0].members_ =
